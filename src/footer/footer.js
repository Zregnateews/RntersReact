      ...
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="col-sm-4 footer_section text-left">
            ...
            <form className="footer__subscribe_form form-inline" action="/pt/subscribe_newsletter" acceptCharset="UTF-8"
          ...
          <div className="col-sm-4 footer_section">
            <p><b style={{textTransform: "uppercase"}}>Para mais informações contacta:</b></p>
            <div className="row">
